...
class BusinessTestClass(TestCase):
    ...
    def setUp(self):
        ...
        self.neighborhood = Neighborhood(id=1,name='Test name',location=self.location,admin=self.user,occupants=1)
        self.category = Category(id=1,name='Test name')
        self.business = Business(id=1,name='Test',user=self.user,description='Test description',neighborhood=self.neighborhood,category=self.category,email='test@test.com')
        self.location.save()
